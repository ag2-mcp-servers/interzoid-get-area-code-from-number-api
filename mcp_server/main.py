...
#   timestamp: 2025-06-29T03:48:20+00:00
...
from models import GetareacodefromnumberGetResponse
...
@app.get(
    ...
    tags=['area_code_retrieval'],
)
def getareacodefromnumber(license: str, number: str = ...):
    """
